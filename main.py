...
# 한국에서 구글 검색 시 바로 확인할 수 있는 이미지 링크로 교체했습니다.
cities = {
    "파리": {
        "에펠탑": {
...
""",
            "image_url": "https://img.trip.com/images/0104h1200085d7m1hD406_W_1000_750_R5_SU.jpg",  # 트립닷컴 이미지 (한국에서 접속 가능)
            "nearby": [
...
""",
            "image_url": "https://upload.wikimedia.org/wikipedia/commons/thumb/6/66/The_Louvre_Museum_in_Paris.jpg/1200px-The_Louvre_Museum_in_Paris.jpg",  # 위키미디어 공용 이미지 (안정적)
            "nearby": [
...
""",
            "image_url": "https://a.cdn-hotels.com/gdcs/production116/d217/63b27670-388f-11e8-b611-0242ac11000b.jpg",  # 호텔스닷컴 이미지 (한국에서 접속 가능)
            "nearby": [
...
""",
            "image_url": "https://res.klook.com/image/upload/fl_lossy,q_85/c_fill,w_750,h_560/v1642407519/blog/e06b52a5-IMG_1427.jpg",  # 클룩 이미지 (한국에서 접속 가능)
            "nearby": [
...
""",
            "image_url": "https://img.travel.rakuten.co.jp/share/image/international/FRANCE/NICE/nice_main.jpg",  # 라쿠텐 트래블 이미지 (한국에서 접속 가능)
            "nearby": [
...
""",
            "image_url": "https://a.travel-assets.com/findhotels/assets/default_images/3000000000000.jpg",  # 익스피디아 이미지 (한국에서 접속 가능)
            "nearby": [
